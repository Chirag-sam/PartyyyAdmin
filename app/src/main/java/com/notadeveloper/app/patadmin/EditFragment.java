...
public class EditFragment extends Fragment {
  ...
  DatabaseReference ref;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
      ...
      nopot = view.findViewById(R.id.nopot);
      edit = view.findViewById(R.id.edit);
      add = view.findViewById(R.id.add123);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              final AutoCompleteTextView flavour = dialog.findViewById(R.id.flavour);
              final TextView pottext = dialog.findViewById(R.id.pottext);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              final AutoCompleteTextView price = dialog.findViewById(R.id.price);
              TextInputLayout price1 = dialog.findViewById(R.id.price1);
              Button confirm = dialog.findViewById(R.id.confirm);
                confirm.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
